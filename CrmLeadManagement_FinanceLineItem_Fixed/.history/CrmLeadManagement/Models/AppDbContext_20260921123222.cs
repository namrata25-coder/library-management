    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        lead.OwnsMany(l => l.Estimations, est =>
        {
            ...
            est.OwnsMany(e => e.Items, item =>
            {
                ...
                item.WithOwner(i => i.Estimation)
                    .HasForeignKey(i => i.EstimationId_FK)
        ...
        lead.OwnsMany(l => l.Quotations, quo =>
        {
            ...
            quo.OwnsMany(q => q.Items, item =>
            {
                ...
                item.WithOwner().HasForeignKey("QuotationId_FK");
            });
        });
        ...
        modelBuilder.Entity<FollowUpSettings>().HasKey(f => f.Id);
    }
}
