...
if (string.IsNullOrWhiteSpace(connectionString))
{
    throw new InvalidOperationException(
        "Production requires a PostgreSQL connection string in "
        + "ConnectionStrings__DefaultConnection. Set that environment variable before starting the application.");
}
